...
if __name__ == "__main__":
    ...
    dirname = '/home/mlm08/celeb/'
    trainval = []
    y_test = []
    seed_number = 7
    trainval_seed_first = 77
    trainval_seed_second = 777
    parsing_word = ' '
    #classname = '2'
    ...
    for (path, dir, files) in os.walk(dirname):
        ...
        for i in dir:
            ...
            #excute_trainval_dataset(image_dir, train_second, test, val_second, fulls, trainval_seed_first)
            #excute_trainval_dataset(image_dir, train_third, test, val_third, fulls, trainval_seed_second)
